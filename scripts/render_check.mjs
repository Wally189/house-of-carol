...
await browser.close();
console.log('PASS: problem-led main catalogue remains separate from case studies and worked examples; seven text-led service-area choices, non-duplicative problem-led Operations and AI service areas, 53 canonical product pages and worked-example journeys pass browser regression at 1440, 1280, 1024, 800, 760, 430, 390, 360 and 320px plus 200% text reflow; compact layouts stack rather than compress; approved category illustrations remain controlled and decorative; active temporary Formspree contact form remains accessible and enabled; serious/critical axe checks cover desktop and 390px mobile.');