...
const home = await page.evaluate(() => {
  ...
  return { coarse, grid: exterior.gridTemplateColumns, copyBottom: copy.bottom, houseTop: house.top, build, run13 };
});
...
await page.screenshot({ path: 'qa-artifacts/run13-home-wide-touch.png', fullPage: false });
...
await browser.close();
console.log('PASS: Run 13 independent coarse-pointer/wide-viewport regression');
